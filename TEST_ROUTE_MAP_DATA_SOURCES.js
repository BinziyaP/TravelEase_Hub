// Test script to verify route map data source handling
console.log("🧪 Testing Route Map Data Sources...");

// Simulate package data with multiple data sources
const packageData = {
  route_coordinates: [
...
// Test the fixed logic - use ONLY route_coordinates
let allLocations = [];
...
if (uniqueCoords.length === packageData.route_coordinates.length) {
  console.log("✅ SUCCESS: Using only route_coordinates (no mixing data sources)!");
} else {
  console.log("❌ FAILURE: Data sources are being mixed!");
}
