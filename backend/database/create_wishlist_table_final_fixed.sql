-- FINAL FIXED: Create wishlist table for packages
-- This script fixes ALL column name issues for both packages and agencies tables
...
-- FINAL FIXED: Create a view for wishlist with package details
-- Using correct column names from both packages and agencies tables
...
SELECT 
    ...
    p.id,
    p.name as package_name,  -- FIXED: packages table uses 'name'
    p.destination,
    p.duration_days as duration,  -- FIXED: packages table uses 'duration_days'
    p.price,
    p.max_travelers,
    p.description,
    ...
    a.agency_name,  -- FIXED: agencies table uses 'agency_name'
    a.contact_person,  -- FIXED: agencies table uses 'contact_person'
    a.email as contact_email,  -- FIXED: agencies table uses 'email' not 'contact_email'
    a.phone as contact_phone  -- FIXED: agencies table uses 'phone' not 'contact_phone'
