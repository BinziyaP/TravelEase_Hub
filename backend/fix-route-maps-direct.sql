...
BEGIN
    ...
    -- Add estimated_travel_time_hours column if it doesn't exist
...
-- 2. Update approved packages that don't have route coordinates
UPDATE packages 
