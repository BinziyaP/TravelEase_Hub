...
const himalayanPackages = [
  {
    ...
    transportation_included: ['flights', 'airport_transfer', 'local_transport'],
    transportation_prices: { flights: 15000, airport_transfer: 2000, local_transport: 1500 },
  ...
  },
  {
    ...
    transportation_included: ['bus', 'local_transport'],
    transportation_prices: { bus: 1200, local_transport: 800 },
  ...
  },
  {
    ...
    transportation_included: ['airport_transfer', 'car_rental'],
    transportation_prices: { airport_transfer: 600, car_rental: 15000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['bus', 'car_rental'],
    transportation_prices: { bus: 2500, car_rental: 12000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
...
const coastalPackages = [
  {
    ...
    transportation_included: ['flights', 'airport_transfer', 'local_transport'],
    transportation_prices: { flights: 35000, airport_transfer: 8000, local_transport: 4000 },
    meals_included: ['breakfast', 'lunch', 'dinner', 'snacks'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['airport_transfer', 'local_transport'],
    transportation_prices: { airport_transfer: 1200, local_transport: 3500 },
  ...
  },
  {
    ...
    transportation_included: ['flights', 'airport_transfer', 'car_rental'],
    transportation_prices: { flights: 25000, airport_transfer: 2500, car_rental: 6000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['train', 'local_transport'],
    transportation_prices: { train: 3500, local_transport: 2500 },
    meals_included: ['breakfast'],
    itinerary: [
...
const desertPackages = [
  {
    ...
    transportation_included: ['flights', 'airport_transfer', 'car_rental'],
    transportation_prices: { flights: 22000, airport_transfer: 3500, car_rental: 12000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['train', 'car_rental'],
    transportation_prices: { train: 4500, car_rental: 16000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['airport_transfer', 'car_rental'],
    transportation_prices: { airport_transfer: 2500, car_rental: 14000 },
    meals_included: ['breakfast', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['airport_transfer', 'local_transport'],
    transportation_prices: { airport_transfer: 1800, local_transport: 8500 },
...
const wanderlustPackages = [
  {
    ...
    transportation_included: ['flights', 'train', 'local_transport'],
    transportation_prices: { flights: 55000, train: 25000, local_transport: 12000 },
    meals_included: ['breakfast'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['train', 'local_transport'],
    transportation_prices: { train: 18000, local_transport: 12000 },
    meals_included: ['breakfast'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['airport_transfer', 'car_rental'],
    transportation_prices: { airport_transfer: 1500, car_rental: 8500 },
    meals_included: ['breakfast', 'lunch', 'dinner'],
    itinerary: [
  ...
  },
  {
    ...
    transportation_included: ['flights', 'local_transport'],
    transportation_prices: { flights: 18000, local_transport: 4500 },
    meals_included: ['breakfast', 'lunch'],
    itinerary: [
...
async function seed() {
  ...
  for (const agency of agencies) {
    ...
    // Map with agency_id and proper itinerary mapping
  ...
  fs.writeFileSync('full_seed_log_v3.txt', log, 'utf8');
}
